        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="/fantasy" className="hover:text-gray-900 transition-colors">Fantasy Game</a></li>
              <li><a href="/apostas" className="hover:text-gray-900 transition-colors">Apostas Esportivas</a></li>
              <li><a href="/historico" className="hover:text-gray-900 transition-colors">Histórico</a></li>
